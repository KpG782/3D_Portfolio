...
import { featuredBuild, nowBuilding, shipLog } from "@/data/projects";
...
function buildCorpus(): Chunk[] {
  ...
  add(
    "experience",
    "Experience",
    "Ken is AI Automation Engineer at Mufti Finance on contract (Jul 2026–present, Australia, remote), building the AI automation layer for an Australian mortgage brokerage: 30 browser-agent workflows across six major Australian lender portals that log in, complete multi-step valuation and pricing wizards, and stop at a human approval gate, orchestrated from an email-triggered n8n pipeline. He cut per-run LLM cost 96% with a cheap-first model router and built the safety architecture around irreversible financial actions. Before that he was Lead Full-Stack & Mobile Engineer at Jobdun Pty Ltd on contract (May 2026–Aug 2026, Sydney, Australia, remote), where he built and shipped Jobdun — a two-sided job marketplace for the Australian construction trades — from empty repo to live on the Apple App Store (AU) and Google Play. Earlier roles: AI Full-Stack Engineer at Romega Solutions (Jul 2025–Jul 2026, remote, part-time), Software Engineer at CodeVF (real-time collaboration, WebSockets), AI Workflow Automation Engineer at University of Makati (n8n), Lead Software Engineer on Pacebeats, freelance full-stack web (8+ client sites), Flutter developer (5+ cross-platform apps), and technical support at Concentrix. Education: BS Computer Science at University of Makati.",
  );
  add(
    "teamos",
    "TeamOS (internal ops hub)",
    "TeamOS is the portfolio codename for a private team hub Ken built solo in about 3 months for a distributed digital services team — the client is not named publicly. It replaced 4+ separate tools with one hub: project boards and ticketing, attendance with live presence and overtime approvals, recruiting with resume parsing and a consent-gated talent pool, LMS courses/quizzes/certificates, and AI-drafted executive briefings that route to human review. Scale: 46 pages, 56 API route handlers, 31 Postgres tables, ~42K lines of TypeScript. He led the migration off a third-party PM SaaS — SQLite to Supabase Postgres with Drizzle ORM, custom JWT to Supabase Auth + Google OAuth — and shipped four-tier RBAC with middleware route guards. The system is internal; an architecture walkthrough is available on request.",
  );
  add(
    "stack",
    "Tech stack",
